...
export const SpadeIcon = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2C8 6 4 8 4 12a4 4 0 0 0 7 2.6V17H8v2h8v-2h-3v-2.4A4 4 0 0 0 20 12c0-4-4-6-8-10z" />
  </svg>
);

export const ClubIcon = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} style={{ display: 'block' }}>
    <path d="M12 2C10.5 2 9.2 3.3 9.2 4.8C9.2 6.3 10.5 7.5 12 7.5C13.5 7.5 14.8 6.3 14.8 4.8C14.8 3.3 13.5 2 12 2ZM12 9.5C9.5 9.5 7.5 11.5 7.5 14C7.5 16.5 9.5 18.5 12 18.5V22H13V18.5C15.5 18.5 17.5 16.5 17.5 14C17.5 11.5 15.5 9.5 12 9.5ZM12 12C13.1 12 14 12.9 14 14C14 15.1 13.1 16 12 16C10.9 16 10 15.1 10 14C10 12.9 10.9 12 12 12Z" />
  </svg>
);
...
export const DiamondIcon = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} style={{ display: 'block' }}>
    <path d="M12 2L2 12L12 22L22 12L12 2Z" />
  </svg>
);

export const EnergyIcon = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#f59e0b' }}>
...
export const StoreIcon = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
