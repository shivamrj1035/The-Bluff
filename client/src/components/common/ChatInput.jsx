      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, position: 'relative' }}>
        ...
        <button
          ...
          style={{
            ...
            background: open ? 'rgba(124,58,237,0.25)' : 'rgba(255,255,255,0.06)',
            color: open ? '#a78bfa' : '#6b7280',
            cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '1.1rem', transition: 'all 0.2s', flexShrink: 0,
            boxShadow: open ? '0 0 0 1px rgba(124,58,237,0.4)' : 'none',
          }}
        >
          💬
        </button>
        ...
        {open && (
          <div style={{
            ...
            background: 'rgba(10,10,20,0.95)', border: '1px solid rgba(124,58,237,0.35)',
            ...
            <button
              ...
              disabled={!msg.trim()}
              style={{
                background: msg.trim() ? 'rgba(124,58,237,0.8)' : 'rgba(255,255,255,0.05)',
  ...
  return (
    <div style={{
      ...
      <button
        ...
        disabled={!msg.trim()}
        style={{
          background: msg.trim() ? 'rgba(124,58,237,0.8)' : 'transparent',
          border: 'none', borderRadius: 8, color: '#fff', cursor: msg.trim() ? 'pointer' : 'default',
